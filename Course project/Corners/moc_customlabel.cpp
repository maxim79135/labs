...
QT_MOC_LITERAL(1, 12, 14), // "on_press_label"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "CustomLabel\0on_press_label\0"
};
...
void CustomLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_press_label(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (CustomLabel::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomLabel::on_press_label)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomLabel::on_press_label()
{
