...
var
  ...
  begin
    ...
    begin
         ...
         if  ((RGBA_Data[RGBA_Byte_Number]=255) and (RGBA_Data[RGBA_Byte_Number+1]=255) and (RGBA_Data[RGBA_Byte_Number+2]=255) )  then RGBA_Data[RGBA_Byte_Number+3]:=0 else RGBA_Data[RGBA_Byte_Number+3]:=255;
